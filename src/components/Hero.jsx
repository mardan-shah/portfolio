  ...
  return (
    <section className=' relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[80px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>Hi, I'm <span className='text-[#915eff]'>Ali <span className='hidden md:inline-block'> Mardan</span></span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>I develop User Interfaces<br className=' block sm:hidden'/> and Web Applications</p>
        </div>
      </div>
      <ComputersCanvas />
